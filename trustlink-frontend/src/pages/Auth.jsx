...
const Auth = ({ user, setUser, role, setRole }) => {
  ...
  return (
    <div className="auth-wrapper" style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#030712', padding: '20px' }}>
      
      <motion.div 
        initial={{ opacity: 0, y: 20 }} 
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        style={{ width: '100%', maxWidth: '440px', background: '#0f172a', border: '1px solid #1e293b', borderRadius: '20px', padding: '40px', boxShadow: '0 15px 40px rgba(0,0,0,0.5)' }}
      >
        {/* Brand Header */}
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          <h1 style={{ fontSize: '2.4rem', fontWeight: '800', margin: '0 0 6px', letterSpacing: '-0.03em', color: '#ffffff' }}>
            TrustLink
          </h1>
